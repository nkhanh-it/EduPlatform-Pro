        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="space-y-6">
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-2 rounded-xl bg-primary py-3 px-4 text-white font-bold hover:bg-primary-hover transition-all shadow-lg shadow-primary/25"
            >
