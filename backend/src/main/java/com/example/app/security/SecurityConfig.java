    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.POST, "/api/media/playback/session").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/media/play/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/media/hls/**").permitAll()
